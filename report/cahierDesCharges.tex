...
\paragraph*{}
1.Le système est principalement conçu pour fonctionner sous architecture UNIX.% mais aussi compatible avec le système Windows. % euh, attention, les fichiers nécessiteront peut-être un traitement particulier sous windows
